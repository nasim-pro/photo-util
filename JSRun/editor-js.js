...
"use strict";
(self.webpackChunkinteractive_examples = self.webpackChunkinteractive_examples || []).push([[554], {
    89: (t,e,n)=>{
        var r = n(820)
          , o = n(758)
          , a = n(557)
        ...
        !function() {
            ...
            function y() {
                ...
                d = (0,
                i.Q_)(e, t.textContent || "", (0,
                i.si)())
            }
            r.$(e) ? (document.documentElement.classList.add("js"),
            t?.dataset.height && document.getElementById("editor").classList.add(t.dataset.height),
            ...
            n.addEventListener("click", (()=>{
                ...
                function(t) {
                    ...
                    c.addEventListener("animationend", (()=>c.classList.remove("fade-in")))
                }((0,
                i.kt)(d))
            }
            )),
            s.addEventListener("click", (()=>window.location.reload()))) : console.warn(`Feature ${e} is not supported; code editor disabled.`)
        }()
    }
    ,
    758: (t,e,n)=>{
